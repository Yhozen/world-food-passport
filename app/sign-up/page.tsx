      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="border-4 border-black bg-card p-8 shadow-[8px_8px_0px_0px_#000]">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 bg-primary border-4 border-black flex items-center justify-center shadow-[3px_3px_0px_0px_#000]">
          ...
          <form action={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-4 border-4 border-black bg-primary text-black font-bold uppercase tracking-wide shadow-[4px_4px_0px_0px_#000] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
